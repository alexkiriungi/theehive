  ...
  paddingY} flex-col`}>
    ...
    flex-col mb-8 w-full`}>
      ...
      mr-10">
        ...
        className="w-[266px] h-[72px] object-contain"
         />
         <p className={`${styles.paragraph} mt-4 max-w-
         [310px]`}>A new way to make the payments easy,
         realiable and secure</p>
      </div>
    ...
    md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3F3E45]">
      <p className="font-poppins font-normal text-center
       font-medium text-[18px]leading-[27px] text-white">
        2023 Hivebank. All Rights Reserved.
      </p>
